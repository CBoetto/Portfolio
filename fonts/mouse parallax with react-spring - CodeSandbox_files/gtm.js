...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_eventLabel":["template",["macro",5],"%"],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      "vtp_enableFirebaseCampaignData":true,
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E\"function\"===typeof require?require([\"https:\/\/cdn.amplitude.com\/libs\/amplitude-4.5.2-min.gz.js\"],function(c){c.getInstance().init(\"a205ed9b06a7baf5a594bdd30293aa80\");window.amplitude=c;setTimeout(function(){c.logEvent(\"pageview\",{path:location.pathname+location.search})},1E3)}):(function(c,g){function h(f,a){f.prototype[a]=function(){this._q.push([a].concat(Array.prototype.slice.call(arguments,0)));return this}}function k(a){function f(b){a[b]=function(){a._q.push([b].concat(Array.prototype.slice.call(arguments,\n0)))}}for(var b=0;b\u003Cl.length;b++)f(l[b])}var b=c.amplitude||{_q:[],_iq:{}},a=g.createElement(\"script\");a.type=\"text\/javascript\";a.async=!0;a.src=\"https:\/\/cdn.amplitude.com\/libs\/amplitude-4.5.2-min.gz.js\";a.onload=function(){c.amplitude.runQueuedFunctions\u0026\u0026c.amplitude.runQueuedFunctions()};var d=g.getElementsByTagName(\"script\")[0];d.parentNode.insertBefore(a,d);a=function(){this._q=[];return this};d=\"add append clearAll prepend set setOnce unset\".split(\" \");for(var e=0;e\u003Cd.length;e++)h(a,d[e]);b.Identify=\na;a=function(){this._q=[];return this};d=[\"setProductId\",\"setQuantity\",\"setPrice\",\"setRevenueType\",\"setEventProperties\"];for(e=0;e\u003Cd.length;e++)h(a,d[e]);b.Revenue=a;var l=\"init logEvent logRevenue setUserId setUserProperties setOptOut setVersionName setDomain setDeviceId setGlobalUserProperties identify clearUserProperties setGroup logRevenueV2 regenerateDeviceId logEventWithTimestamp logEventWithGroups setSessionId resetSessionId\".split(\" \");k(b);b.getInstance=function(a){a=(a\u0026\u00260!==a.length?a:\"$default_instance\").toLowerCase();\nb._iq.hasOwnProperty(a)||(b._iq[a]={_q:[]},k(b._iq[a]));return b._iq[a]};c.amplitude=b}(window,document),amplitude.getInstance().init(\"a205ed9b06a7baf5a594bdd30293aa80\"),setTimeout(function(){amplitude.logEvent(\"pageview\",{path:location.pathname+location.search})},1E3));\u003C\/script\u003E",
...
g))}if(void 0!==g&&0>=g)return!0;(d=d.parentElement)&&(e=u.getComputedStyle(d,null))}return!1};var bh=u.clearTimeout,ch=u.setTimeout,Q=function(a,b,c){if(se()){b&&z(b)}else return Pa(a,b,c)},dh=function(){return new Date},R=function(){return u.location.href},eh=function(a){return C(db(a),"fragment")},fh=function(a){return cb(db(a))},T=function(a,b){return Ic(a,b||2)},gh=function(a,b,c){b&&(a.eventCallback=b,c&&(a.eventTimeout=c));return Ge(a)},hh=function(a,b){u[a]=b},U=function(a,b,c){b&&(void 0===u[a]||c&&
...
Y.a.jsm=["customScripts"],function(){(function(a){Y.__jsm=a;Y.__jsm.g="jsm";Y.__jsm.h=!0;Y.__jsm.b=0})(function(a){if(void 0!==a.vtp_javascript){var b=a.vtp_javascript;try{var c=U("google_tag_manager");return c&&c.e&&c.e(b)}catch(d){}}})}();Y.a.c=["google"],function(){(function(a){Y.__c=a;Y.__c.g="c";Y.__c.h=!0;Y.__c.b=0})(function(a){return a.vtp_value})}();
